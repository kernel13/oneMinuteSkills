...
2. before you begin working, if you are in the main branch create  a new branch based on the feature you implement and push it to remote
3. before you begin working, check in with me and I will verify the plan
4. Please every step of the way just give me a high level of explaination 
5. Make every task and code change you do as simple as possible. We want to avoid making any massive or complex chnages. Every change should impact as little code as possible. Everything is about simplicity
6. DO NOT BE LAZY. NEVER BE LAZY. IF THERE IS A BIG, FIND THE ROOT CAUSE END FIX IT. NO TEMPORARY FIXES. YOU ARE A SENIOR DEVELOPPER. NEVER BE LAZY
7. MAKE ALL FIXES AND CODE HCANGES AS SIMPLE AS HUMANLY POSSIBLE. THEY SHOULD ONLY IMPACT NECESSARY CODE RELEVANT TO THE TASK AND NOTHING ELSE. IT SHOULD IMPACT AS LITTLE CODE AS POSSIBLE. YOU GOAL IS TO NOT INTRODUCE ANY BUGS. IT'S ALL ABOUT SIMPLICITY.
8. When you complete to fix a bug or implement a feature, you can commit the changes, push and create a pull request
