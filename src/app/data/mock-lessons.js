...
exports.MOCK_LESSONS = void 0;
exports.getAllMockLessons = getAllMockLessons;
exports.getMockLessonsByCategory = getMockLessonsByCategory;
exports.getMockLessonById = getMockLessonById;
exports.getMockLessonsByDifficulty = getMockLessonsByDifficulty;
exports.getRandomMockLesson = getRandomMockLesson;
exports.getDailyMockLesson = getDailyMockLesson;
/**
 * Mock Lesson Data
 * Sample lessons for development and testing
 */
exports.MOCK_LESSONS = [
    // TECHNOLOGY lessons
    {
        id: 'lesson-tech-001',
 ...
 */
function getAllMockLessons() {
    return exports.MOCK_LESSONS;
}
/**
 * Get lessons by category
 */
function getMockLessonsByCategory(category) {
    return exports.MOCK_LESSONS.filter((lesson) => lesson.category === category);
}
/**
 * Get lesson by ID
 */
function getMockLessonById(id) {
    return exports.MOCK_LESSONS.find((lesson) => lesson.id === id);
}
/**
 * Get lessons by difficulty
 */
function getMockLessonsByDifficulty(difficulty) {
    return exports.MOCK_LESSONS.filter((lesson) => lesson.difficulty === difficulty);
}
/**
 * Get random lesson
 */
function getRandomMockLesson() {
    const randomIndex = Math.floor(Math.random() * exports.MOCK_LESSONS.length);
    return exports.MOCK_LESSONS[randomIndex];
}
/**
 * Get lessons for today (simple daily rotation)
 * Returns a lesson based on day of week
 */
function getDailyMockLesson() {
    const dayOfWeek = new Date().getDay();
    const lessonIndex = dayOfWeek % exports.MOCK_LESSONS.length;
    return exports.MOCK_LESSONS[lessonIndex];
}
